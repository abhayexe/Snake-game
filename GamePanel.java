...
public class GamePanel extends JPanel implements ActionListener {
    ...
    private void loadImages() {
        ...
        ImageIcon iib = new ImageIcon(getClass().getResource("background.png"));
        background = iib.getImage().getScaledInstance(B_WIDTH, B_HEIGHT, Image.SCALE_SMOOTH); 
    }
    ...
    private void gameOver(Graphics g) {
        String msg = "thanks for playing Snakie!";
        Font small = new Font("Helvetica", Font.BOLD, 20);
        FontMetrics metr = getFontMetrics(small);

        String msg2 = "GAME OVER";
        Font small2 = new Font("Helvetica", Font.BOLD, 40);
        ...
        g.setFont(small2);
        g.drawString(msg2, (B_WIDTH - metr2.stringWidth(msg2)) / 2, B_HEIGHT / 3);
    }
